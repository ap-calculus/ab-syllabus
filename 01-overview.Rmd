...
1. [Create a Khan Academy account](https://www.khanacademy.org/signup){target="_blank"} with your school-issued e-mail address.

2. Visit [https://www.khanacademy.org/join](https://www.khanacademy.org/join){target="_blank"} and enter class code (PHHGRQCY). Alternatively, visit this link [https://www.khanacademy.org/join/PHHGRQCY](https://www.khanacademy.org/join/PHHGRQCY){target="_blank"} to join the class. Please do not join this Khan Academy classroom unless you are enrolled in Mr. Li's Calculus AB class. 
...
[College Board: AP Calculus AB](https://apcentral.collegeboard.org/courses/ap-calculus-ab/course){target="_blank"}

  * [Past Free Response Questions](https://apcentral.collegeboard.org/courses/ap-calculus-ab/exam/past-exam-questions){target="_blank"}
  * AP Question Bank (will be released by College Board on August 1)

[Paul's Online Math Notes (Calculus I)](http://tutorial.math.lamar.edu/Classes/CalcI/CalcI.aspx){target="_blank"}
