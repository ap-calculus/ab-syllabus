...
1. [Create a Khan Academy account](https://www.khanacademy.org/signup){target="_blank"} with your e-mail address.

2. Visit [https://www.khanacademy.org/join](https://www.khanacademy.org/join){target="_blank"} and enter the class code given to you in class.
